...
# ============================================================
# 1️⃣ Exclusión laboral por manzana (desde CPV24, no personas)
# ============================================================

message("Calculando exclusión laboral desde CPV24...")
...
manzanas_pre <<- manzanas %>%
  mutate(
    COMUNA = trimws(toupper(COMUNA)),
    escolaridad_disc = pmin(pmax(8.5, floor(prom_escolaridad18 * 2) / 2), 17),
    escolaridad_col  = ifelse(
      is.na(prom_escolaridad18),
      8.4,
      pmin(pmax(8.5, floor(prom_escolaridad18 * 2) / 2), 17)
    )
  )

# ============================================================
# 3️⃣ Cache comunal de percentiles (segregación real)
# ============================================================
